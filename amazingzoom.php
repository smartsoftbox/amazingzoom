...
class Amazingzoom extends Module
{
    ...
    {
        Configuration::updateValue('AMAZINGZOOM_LIVE_MODE', false);
            ...
            'form' => array(
                ...
                'input' => array(
                    ...
                    array(
                        ...
                        'name' => 'AMAZINGZOOM_ACCOUNT_EMAIL',
                        'label' => $this->l('Email'),
                    ),
                    array(
                        'type' => 'password',
                        'name' => 'AMAZINGZOOM_ACCOUNT_PASSWORD',
    ...
    {
        return array(
            'AMAZINGZOOM_LIVE_MODE' => Configuration::get('AMAZINGZOOM_LIVE_MODE', true),
            'AMAZINGZOOM_ACCOUNT_EMAIL' => Configuration::get('AMAZINGZOOM_ACCOUNT_EMAIL', 'contact@prestashop.com'),
            'AMAZINGZOOM_ACCOUNT_PASSWORD' => Configuration::get('AMAZINGZOOM_ACCOUNT_PASSWORD', null),
        );
    }
